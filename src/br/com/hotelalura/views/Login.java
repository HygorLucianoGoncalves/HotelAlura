...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/br/com/hotelalura/imagenes/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/br/com/hotelalura/imagenes/lOGO-50PX.png")));
