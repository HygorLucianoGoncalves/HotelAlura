...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/br/com/hotelarura/imagenes/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/br/com/hotelarura/imagenes/lOGO-50PX.png")));
