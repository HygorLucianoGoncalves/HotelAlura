...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("/br/com/hotelarura/imagenes/aH-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/br/com/hotelarura/imagenes/menu-img.png")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/br/com/hotelarura/imagenes/aH-150px.png")));
		panel.add(logo);
		...
		imageLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/br/com/hotelarura/imagenes/login.png")));
